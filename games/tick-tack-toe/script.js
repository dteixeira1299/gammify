...
function generateRandomKey() {
    ...
    let e = document.getElementById("game-key");
    e.innerHTML=r;
}
...
function onGameModeChange(mode, _el) {
    ...
    if (mode == 'PvP') {
        generateRandomKey();
        document.getElementById("game-key-label").style.display="inline"
        document.querySelector(`.mode.PvC`).classList.remove('mode-selected');
    }
    else if (mode == 'PvC') {
        document.getElementById("game-key-label").style.display="none"
